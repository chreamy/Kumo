...
module.exports = async (client, message, args) => {
    try {
        ...
        if (!args[0]) {
            return message.reply('Please provide a number! Usage: !yuna <number> (1-3333)');
        }
        ...
        if (isNaN(number) || number < 1 || number > 3333) {
            return message.reply('Please provide a valid number between 1 and 3333!');
        }
        ...
        message.channel.send('An error occurred while generating the Yuna NFT.');
    }
};
